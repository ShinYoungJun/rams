 ...
 */
OpenLayers.Layer.TileCacheTest = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    getURL: function(bounds) {
        ...
        var components = [
			...
			"L" + (tileZ + 1),
			parseInt(tileY),
			parseInt(tileX) + '.' + this.extension
			*/
			"Y"+ parseInt(tileY),
			"X"+ parseInt(tileX) + "." + thie.extension
        ];
    ...
    CLASS_NAME: "OpenLayers.Layer.TileCacheTest"
});
