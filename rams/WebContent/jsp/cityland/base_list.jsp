		...
		<tr>
		  <td>
			  ...
			  <tr>
				...
				<tr onclick="goView('${blist.PP_NAME}','${blist.LAND_ADDR}','${blist.USE_N}','${blist.ADMI_N}','${blist.PP_CLASS_N}','${blist.AMT}','${blist.PP_CNT}','${blist.PP_AREA}','${blist.OWNER_N}','${blist.OWN_CITY_N}');" style="cursor:pointer" >
					<td>${blist.RN}</td>
					<td>${blist.ACQ_DAY}</td>
