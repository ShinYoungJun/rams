...
<div id="cont03">
	<div class="list2">
	  ...
	  <c:forEach items="${nlist}" var="notice" varStatus="idx">
		  <tr onmouseover="trMoouseOver(this)" onmouseout="trMoouseOut(this)" style="cursor:pointer" onclick="goView('${notice.SEQNUM}');">
			<td class="cont">${notice.SEQNUM}</td>
			<td class="cont">${notice.TITLE}</td>
			<td class="cont">${notice.REGISTNAME}</td>
			<td class="cont">${notice.REGISTDATE}</td>
			<td class="cont">${notice.VIEWCNT}</td>
		  </tr>
	  </c:forEach>
