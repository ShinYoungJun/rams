...
<link rel="stylesheet" href="/rams/css/write_doro.css" type="text/css" />
	...
	function goWritePrc(){
		...
		form.action = "/rams/board/notice_write_prc.do";
		form.submit();
...
<div id="cont01">
  ...
  <table width="817" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="right">
      	...
      	<a href="#" class="blue1" onclick="goList();">공지사항 </a> > <strong>공지사항 작성</strong>
      </td>
    </tr>
  </table>
  </div>
  ...
  <!-- 검색 -->
  <div>
    <h2><img src="/rams/images/board/tt03.gif" alt="공지사항_공지사항작성"/></h2>
	<div class="tab">
	  <table width="817" border="0" cellspacing="0" cellpadding="0">
        <tr>
			  ...
			  <table width="817" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<td class="cont4">
						...
						<input name="USERID" type="hidden" class="formBox6" value="${userId}" />
					</td>
				  </tr>
				  <tr>
					<td class="cont3">제목</td>
					<td class="cont4">
						<input name="TITLE" type="text" class="formBox9" value="${notice.TITLE}" />
					</td>
				  </tr>
				  <tr>
