...
<input type="hidden" id="GUBUN" name="GUBUN" value="${GUBUN}"></input>
<div id="cont02">
	  <h3>
	  	<c:choose>
	  	<c:when test="${GUBUN == 2}">
	  ...
	  <table width="817" border="1" cellpadding="1" cellspacing="1" bordercolor="#d3e2ea">
		<tr>
		  <td>
			  ...
			  <tr>
				<th width="80" scope="col">${GUBUN_NM}명</th>
			  ...
			  <tr>
				...
				<td>${blist.ADDR}</td>
				<td>${blist.ADMINSTNAME}</td>
				<td>${blist.TEL}</td>
				<td>${blist.ETC}</td>
				<td><img src="/rams/images/common/btn_del3.gif" alt="삭제" width="62" height="19" onclick="goDelete('${blist.SUITORNUM}');" style="cursor:pointer;" /></td>
			  </tr>
	   		  </c:forEach>
	   		  	<tr>
