...
<body>
<div id='left1' align="center" style="position:absolute;left:0px;">
      ...
      <td height="100%" class="cont">
		  ...
		  <tr>
			<td>
				<table width="250" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<th height="35" valign="bottom" scope="row"><img src="/rams/images/map/l_st_info3.gif" alt="상세정보" width="250" height="29" border="0" usemap="#Map" style='cursor:hand;' /></th>
				  </tr>
				  <tr>
