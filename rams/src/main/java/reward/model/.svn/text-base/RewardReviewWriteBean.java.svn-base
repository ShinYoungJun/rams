...
public class RewardReviewWriteBean extends RamsBaseBean {
	...
	private String TOTJIBUN      ="";
	private String REQJIBUN      ="";
	private String GOSIID        ="";
	private String CONSTNAME     ="";
	private String ANNPERMISSION ="";
	private String LINENAME      ="";
	private String CONSTCATEG    ="";
	private String STARTSECTION  ="";
	private String ENDSECTION    ="";
	private String CONSTPLACE    ="";
	...
	public void setANNOUNCENUM(String aNNOUNCENUM) {
	...
	public void setAFFAIRNUM(String aFFAIRNUM) {
		AFFAIRNUM = aFFAIRNUM;
	}
	...
	public String getTOTJIBUN() {
		return TOTJIBUN;
	}
	public void setTOTJIBUN(String tOTJIBUN) {
		TOTJIBUN = tOTJIBUN;
	}
	public String getREQJIBUN() {
		return REQJIBUN;
	}
	public void setREQJIBUN(String rEQJIBUN) {
		REQJIBUN = rEQJIBUN;
	}
	...
	public String getANNPERMISSION() {
		return ANNPERMISSION;
	}
	public void setANNPERMISSION(String aNNPERMISSION) {
		ANNPERMISSION = aNNPERMISSION;
	}
	...
	public String getCONSTCATEG() {
		return CONSTCATEG;
	}
	public void setCONSTCATEG(String cONSTCATEG) {
		CONSTCATEG = cONSTCATEG;
	}
	...
	public void setCONSTPLACE(String cONSTPLACE) {
		CONSTPLACE = cONSTPLACE;
	}
